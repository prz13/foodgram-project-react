...
from recipes.models import (
    Favorite, Ingredient, Recipe, Recipe_ingredient, Shopping_cart, Tag,
)
from users.models import Subscribe, User

class BaseCustomViewSet(
...
class UserViewSet(BaseCustomViewSet):
...
class IngredientViewSet(BaseModelViewSet):
...
class RecipeViewSet(viewsets.ModelViewSet):
    ...
    def download_shopping_cart(self, request, **kwargs):
        ...
        file_list = []
        [file_list.append('{} - {} {}.'.format(*ingredient)) for ingredient in ingredients]
